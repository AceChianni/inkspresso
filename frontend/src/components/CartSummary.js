...
const CartSummary = ({ cartItems, total }) => {
  ...
  return (
    <div className="p-4">
      ...
      {/* Edit Cart Button */}
      <button
        className="mt-4 bg-orange-500 text-white py-2 px-4 rounded transition duration-300 ease-in-out hover:bg-orange-700 dark:bg-orange-600 dark:hover:bg-orange-800"
