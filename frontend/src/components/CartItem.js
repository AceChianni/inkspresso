    ...
    <div className="flex justify-between items-center p-4 border-b border-gray-300 dark:border-neutral">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-gray-900 dark:text-white">${item.price}</p> {/* ✅ Fix applied here */}
        </div>
      </div>
      <div className="flex items-center gap-4">
        <input
          ...
          value={item.quantity}
          min="1"
          className="w-12 text-center border p-2 rounded bg-white text-gray-900 dark:bg-gray-200 dark:text-gray-900"
