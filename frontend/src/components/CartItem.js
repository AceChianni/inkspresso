    ...
    <div className="flex justify-between items-center p-4 border-b border-gray-300 dark:border-neutral">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          <h4 className="font-semibold text-text-primary dark:text-text-light">{item.name}</h4> {/* Light text in dark mode */}
          <p className="text-gray-600 dark:text-text-light">${item.price}</p> {/* Light text in dark mode */}
        </div>
      </div>
      <div className="flex items-center gap-4">
        <input
